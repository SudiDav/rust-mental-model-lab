...
export function SimulationPanel({ type, scenario }: Props) {
  if (type === 'none') return <section role="region" aria-label="text-first lesson" className="rounded-2xl border border-amber-300/15 bg-[#0b1017] p-5"><p className="font-mono text-[10px] uppercase tracking-[0.2em] text-amber-200">Text-first lesson</p><p className="mt-3 text-sm leading-6 text-slate-400">Build the explanation in your own words first. The interactive visualizer for this lesson will be added later without changing the learning path.</p></section>;
