...
const WORLD_SEEDS: Array<[string, string, string, WorldRecord['status']]> = [
  ...
  ['pointers-references', 'World 4 · Pointers and References', 'Addresses, dereferencing, references, and aliasing.', 'published'],
  ['memory-bugs', 'World 5 · Memory Bugs', 'Dangling pointers, use-after-free, leaks, and races.', 'published'],
  ['why-rust', 'World 6 · Why Rust Exists', 'Trade-offs between manual memory, GC, and ownership.', 'published'],
  ['ownership', 'World 7 · Ownership', 'Moves, Copy, Clone, scope, and Drop.', 'published'],
  ['borrowing', 'World 8 · Borrowing', 'Shared references as temporary access.', 'published'],
